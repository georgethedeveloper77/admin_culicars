...
<head>
    ...
    <!-- https://laracasts.com/discuss/channels/inertia/why-no-title-tag-inside-page-source -->
    {{-- <title>{{ $page['props']['seot'] ?? '' }}</title> --}}
    @if (!empty(adsConfig()['isDisplayGoogleAdsense']))
        <meta name="google-adsense-account" content={{ adsConfig()['adsClient'] }}>

        <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client={{ adsConfig()['adsClient'] }}"
        crossorigin="anonymous"></script>
    @endif

    {{-- <meta name="description" :content="{{ $page['props']['seod'] ?? '' }}"> --}}
    <!-- {{-- <title inertia>{{ config('app.name', "" ) }}</title> --}} -->
    <!-- <title inertia>{{ $title ?? 'Default Title' }}</title> -->

    <!-- white color issue after update the setting is related with this -->
