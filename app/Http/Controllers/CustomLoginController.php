...
class CustomLoginController extends AuthenticatedSessionController
{
    ...
    protected $backendSettingService, $appleVerify, $phoneVerify, $facebookVerify, $userApiController, $publish, $normalUserRoleId, $googleVerify, $badRequestStatusCode, $userService, $imageService, $successStatus, $okStatusCode, $userExisted, $userNotExisted, $errorStatus, $userNotExistedAndNormalLogin;
    ...
    public function __construct(ImageService $imageService, UserService $userService = null)
    {
