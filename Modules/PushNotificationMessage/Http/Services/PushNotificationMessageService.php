...
{
    protected $firebaseCloudMessagingService, $radioUi, $dropDownUi, $pushNotiMessageApiRelation, $tableName, $publish, $coverImgType, $imageService, $pushNotificationMessageIdCol, $pushNotificationMesssageMessageCol, $pushNotificationMessageDescriptionCol, $coreImageImgParentIdCol, $coreImageImgTypeCol, $successStatus, $createdStatusCode, $okStatusCode, $internalServerErrorStatusCode, $noContentStatusCode, $notFoundStatusCode, $show, $hide, $delete, $unDelete, $viewAnyAbility, $createAbility, $editAbility, $deleteAbility, $code, $screenDisplayUiKeyCol, $screenDisplayUiIdCol, $screenDisplayUiIsShowCol, $coreFieldFilterModuleNameCol, $customUiIsDelCol;

    public function __construct(ImageService $imageService, FirebaseCloudMessagingService $firebaseCloudMessagingService)
    {
    ...
    public function store($request)
    {
        ...
        try {
            ...
            $status = $this->firebaseCloudMessagingService->send_android_fcm_topics_subscribe_fe($data, env('APP_URL'));
    ...
    public function getByIdFromApi($request)
    {
        ...
        $push_notification_message = PushNotificationMessage::where($this->pushNotificationMessageIdCol, $id)->first();
