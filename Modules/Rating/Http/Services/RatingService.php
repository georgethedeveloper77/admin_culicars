...
{
    protected $firebaseCloudMessagingService, $userAccessApiTokenService, $createdStatusCode, $ratingStatusCol, $coverImgType, $imageService, $ratingIdCol, $coreImageImgParentIdCol, $publish, $unPublish, $coreImageImgTypeCol, $ratingApiRelation, $pushNotificationTokenService, $userService, $ratingUserType, $noContentStatusCode, $successStatus, $show, $hide, $delete, $unDelete, $viewAnyAbility, $createAbility, $editAbility, $deleteAbility, $code, $screenDisplayUiKeyCol, $screenDisplayUiIdCol, $screenDisplayUiIsShowCol, $coreFieldFilterModuleNameCol, $customUiIsDelCol;

    public function __construct(FirebaseCloudMessagingService $firebaseCloudMessagingService, ImageService $imageService, PushNotificationTokenService $pushNotificationTokenService, UserService $userService, UserAccessApiTokenService $userAccessApiTokenService)
    {
