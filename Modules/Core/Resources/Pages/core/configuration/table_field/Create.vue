...
export default defineComponent({
    ...
    setup(props) {
        ...
        function placeholderLanguageClicked(key){
            if(language_update_modal_placeholder.value.languageStrings.data.length == 0){
                props.languages.forEach(language => {
                    let languageStringObj = {};
                    languageStringObj.language = language;
                    languageStringObj.key = key;
                    ...
                    language_update_modal_placeholder.value.languageStrings.data.push(languageStringObj);
