                            ...
                            <div>
                                ...
                                <div v-if="title == settingColumn[2].label">
                                    ...
                                    <!-- <div class="px-4 py-3">
                                        ...
                                        <ps-label v-if="!backend_setting.backend_water_mask_image" textColor="text-secondary-400 text-xs"> {{ $t('core__be_recommended_size_16_16') }}
                                        </ps-label>
                                        <div v-if="backend_setting.backend_water_mask_image" class="flex items-end pt-4">
                                            <img
                                            v-lazy=" { src: $page.props.uploadUrl + '/' + backend_setting.backend_water_mask_image.img_path, loading: $page.props.sysImageUrl+'/loading_gif.gif', error: $page.props.sysImageUrl+'/default_photo.png' }"
                                             width="200" height="200"
                                                class="w-48 h-48" alt="backend_water_mask_image" />
                                            <ps-button type="button" @click="replaceImageClicked(backend_setting.backend_water_mask_image.id, false,'backend_water_mask_image)" rounded="rounded-full"
                                ...
                                <div v-if="title == settingColumn[3].label">
                                    ...
                                    <div class="px-4 py-3">
                                        ...
                                        <!-- <div v-if="backend_setting.backend_logo" class="flex items-end pt-4">
                                            <img v-lazy="{ src: $page.props.uploadUrl + '/' + backend_setting.backend_logo.img_path, loading: $page.props.sysImageUrl + '/loading_gif.gif', error: $page.props.sysImageUrl + '/default_photo.png' }"
                                                width="200" height="200" class="w-48 h-48" alt="backend_setting" />
                                            <ps-button type="button"
                                                @click="replaceImageClicked(backend_setting.backend_logo.id, true, 'backend_logo')"
                                    ...
                                    <div class="px-4 py-3">
                                        ...
                                        <!-- <div v-if="backend_setting.fav_icon" class="flex items-end pt-4">
                                            <img v-lazy="{ src: $page.props.uploadUrl + '/' + backend_setting.fav_icon.img_path, loading: $page.props.sysImageUrl + '/loading_gif.gif', error: $page.props.sysImageUrl + '/default_photo.png' }"
                                                width="200" height="200" class="w-48 h-48" alt="fav_icon" />
                                            <ps-button type="button"
                                                @click="replaceImageClicked(backend_setting.fav_icon.id, false, 'fav_icon')"
                                                rounded="rounded-full" shadow="drop-shadow-2xl" class="-ms-10 mb-2"
                                                colors="bg-white text-primary-500 dark:bg-secondaryDark-black"
                                                border="border border-1 dark:border-secondary-700 border-secondary-300"
                                                padding="p-1.5" hover="" focus="">
                                    ...
                                    <div class="px-4 py-3">
                                        ...
                                        <!-- <div v-if="backend_setting.backend_water_mask_image" class="flex items-end pt-4">
                                            <img v-lazy="{ src: $page.props.uploadUrl + '/' + backend_setting.backend_water_mask_image.img_path, loading: $page.props.sysImageUrl + '/loading_gif.gif', error: $page.props.sysImageUrl + '/default_photo.png' }"
                                                width="200" height="200" class="w-48 h-48" alt="backend_water_mask_image" />
                                            <ps-button type="button"
                                                @click="replaceImageClicked(backend_setting.backend_water_mask_image.id, false, 'backend_water_mask_image')"
                                                rounded="rounded-full" shadow="drop-shadow-2xl" class="-ms-10 mb-2"
                                                colors="bg-white text-primary-500 dark:bg-secondaryDark-black"
                                                border="border border-1 dark:border-secondary-700 border-secondary-300"
                                                padding="p-1.5" hover="" focus="">
                                ...
                                <div v-if="title == settingColumn[8].label">
                                    ...
                                    <div v-if="form.is_watermask == 1">
                                        ...
                                        <div class="px-4 py-3">
                                            ...
                                            <!-- <div v-if="backend_setting.water_mask_background"
                                                class="flex items-end pt-4">
                                                <img v-lazy="{ src: $page.props.uploadUrl + '/' + backend_setting.water_mask_background.img_path, loading: $page.props.sysImageUrl + '/loading_gif.gif', error: $page.props.sysImageUrl + '/default_photo.png' }"
                                                    width="200" height="200" class="w-auto h-48"
                                                    alt="water_mask_background" />
                                                <ps-button type="button"
                                                    @click="replaceImageClicked(backend_setting.water_mask_background.id, false, 'water_mask_background', 'preview')"
                                                    rounded="rounded-full" shadow="drop-shadow-2xl" class="-ms-10 mb-2"
                                                    colors="bg-white text-primary-500 dark:bg-secondaryDark-black"
                                                    border="border border-1 dark:border-secondary-700 border-secondary-300"
                                                    padding="p-1.5" hover="" focus="">
                                                ...
                                                <div class="">
                                                    <div class="border border-1 rounded p-4">
                                                        <div class="h-auto">
                                                            ...
                                                            <div v-if="can.updateBackendSetting"
...
export default defineComponent({
    ...
    layout: PsLayout,
    props: ['uploadSettingDocUrl', 'firebasePrivateJsonFileName', 'errors', 'backend_setting', 'commonColor', 'status', 'coreFieldFilterSettings', 'can', 'validation', 'paddingList', 'uploadSettingList', 'currentSection'],
    setup(props) {
