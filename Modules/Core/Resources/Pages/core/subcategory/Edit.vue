                        ...
                        <!-- for category dropdown -->
                            ...
                            <div>
                                ...
                                <div v-if="subcategory.cover" class="flex items-end pt-4">
                                    ...
                                    <ps-button type="button" @click="replaceImageClicked(subcategory.cover.id)"
                            ...
                            <div>
                                ...
                                <ps-label-title-3 v-if="!subcategory.icon"> {{ $t('core__be_recommended_size_200_200') }} </ps-label-title-3>
                                <div v-if="subcategory.icon" class="flex items-end pt-4">
                                    ...
                                    <ps-button type="button" @click="replaceIconClicked(subcategory.icon.id)" rounded="rounded-full"
...
export default defineComponent({
    ...
    setup(props) {
        ...
        function replaceImageClicked(id) {
            ps_action_modal.value.openModal(trans('core__be_replace_subcat_photo'),
        ...
        function replaceIconClicked(id) {
            ps_action_modal.value.openModal(trans('core__be_replace_subcat_icon'),
