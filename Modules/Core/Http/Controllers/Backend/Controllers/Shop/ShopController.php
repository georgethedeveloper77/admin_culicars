...
class ShopController extends Controller
{
    ...
    public function index()
    {
        ...
        $custom_field_headers = CustomField::where($conds)->with('custom_field_detail')->get();
        $custom_field_details = CustomFieldAttribute::all();
    ...
    public function create()
    {
        ...
        $custom_field_headers = CustomField::where("module_name", "Shop")->with('custom_field_detail')->get();
        $custom_field_details = CustomFieldAttribute::latest("id")->get();
    ...
    {
        $custom_field_headers = CustomField::with('custom_field_detail')->where("module_name", "Shop")->get();
        return Inertia::render('shop/Customization', [
            "custom_field_headers" => $custom_field_headers,
        ]);
    }

    public function customizationDestroy(CustomField $custom_field_header)
    {
     ...
     */
    public function optionalOrMandatoryChange(CustomField $custom_field_header)
    {
     ...
     */
    public function enableOrDisableChange(CustomField $custom_field_header)
    {
    ...
    // Custom Field Detail
    public function customizationDetailIndex(CustomField $custom_field_header)
    {
        $custom_field_details = CustomFieldAttribute::where('custom_field_header_id', $custom_field_header->id)->latest()->get();
    ...
    public function customizationDetailCreate(CustomField $custom_field_header)
    {
    ...
    public function customizationDetailStore(CustomField $custom_field_header, Request $request)
    {
        try {
    ...
    public function customizationDetailDestroy(CustomField $custom_field_header, CustomFieldAttribute $custom_field_detail)
    {
    ...
    public function customizationDetailEdit(CustomField $custom_field_header, CustomFieldAttribute $custom_field_detail)
    {
    ...
    public function customizationDetailUpdate(CustomField $custom_field_header, CustomFieldAttribute $custom_field_detail, Request $request)
    {
        try {
