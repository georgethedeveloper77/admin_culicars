    ...
    public function rules()
    {
        ...
        $validationRules = array(
            array(
                ...
                'rules' => 'required|min:3|unique:psx_vendor_menus,module_name,',
            ),
            array(
            ...
            array(
                ...
                'rules' => 'required|unique:psx_vendor_menus,module_desc',
            ),
            array(
                'fieldName' => 'module_lang_key',
                'rules' => 'required|unique:psx_vendor_menus,module_lang_key',
            ),
            array(
                'fieldName' => 'module_id',
                'rules' => 'required|unique:psx_vendor_menus,module_id',
            ),
            array(
                'fieldName' => 'ordering',
                'rules' => 'nullable',
