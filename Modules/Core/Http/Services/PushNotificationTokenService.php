...
class PushNotificationTokenService extends PsService
{
    ...
    public function testStatusCode($request)
    {
        ...
        if ($test_code == "500") {
            ...
            $tests = ItemCurrencyApiResource::collection($this->currencyService->getCurrencies($this->publish, $this->default, $limit, $offset));
            ...
            $id = "1";
            $tests = new ItemCurrencyApiResource($this->currencyService->getCurrency($id));
