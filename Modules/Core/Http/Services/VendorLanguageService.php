...
class VendorLanguageService extends PsService
{
    ...
    public function create($request)
    {
        ...
        try {
            ...
            $languageStrings = VendorLanguageString::where($this->langStringLanguageIdCol, $activeLanguage->id)->get();
    ...
    public function getlanguageTable($request)
    {
        ...
        $languageString = VendorLanguageString::when($conds, function ($query, $conds) {
            // search term
