...
class BackendSettingService extends PsService
{
    ...
    public function update($id, $request)
    {
        try {
            ...
            // update firebse private json file
            if ($request->file('firebasePrivateKeyJsonFile')) {
                $firebasePrivateJsonFile = $request->file('firebasePrivateKeyJsonFile');
    ...
    public function index($routeName)
    {
        ...
        if (ps_constant::cgcBaseProjectId !== $project->base_project_id) {
            $uploadSettingList[] = [
                'id' => 4,
