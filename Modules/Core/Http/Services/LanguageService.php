...
class LanguageService extends PsService
{
    ...
    public function create($request)
    {
        ...
        try {
            ...
            $vendorLanguageStrings = VendorLanguageString::where($this->langStringLanguageIdCol, $activeLanguage->id)->get();

            foreach ($vendorLanguageStrings as $languageString) {
                $vendorLanguageStringData[] = [
                    'key' => $languageString->key,
                    'value' => $languageString->value,
                    'language_id' => $language->id,
                    'added_user_id' => Auth::id(),
            ...
            VendorLanguageString::insert($vendorLanguageStringData);
    ...
    public function getLanguage($id = null, $conds = null)
    {
