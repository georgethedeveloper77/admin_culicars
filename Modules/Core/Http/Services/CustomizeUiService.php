...
class CustomizeUiService extends PsService
{
    ...
    public function __construct(LanguageStringService $languageStringService)
    {
        ...
        $this->customizeUiNameCol = CustomField::name;
        $this->customizeUiIdCol = CustomField::id;
        $this->customizeUiTableIdCol = CustomField::tableId;
        $this->customizeUiCoreKeysIdCol = CustomField::coreKeysId;
        $this->customizeUiIsDeleteCol = CustomField::isDelete;
    }
    ...
    public function export()
    {
        ...
        $clientCustomizeUies = CustomField::where('is_core_field', 0)->get();
        $clientCoreFields = CoreField::where('is_core_field', 1)->get();
