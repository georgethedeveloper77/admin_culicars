...
class CurrencyService extends PsService
{
    ...
    public function getCurrency($id = null, $conds = null)
    {
        $currency = Currency::when($id, function ($q, $id) {
            $q->where(Currency::id, $id);
        })
    ...
    public function index($routeName, $request)
    {
        ...
        $currencies = ItemCurrencyWithKeyResource::collection($this->getCurrencies(null, null, null, null, false,  $row, $conds));
