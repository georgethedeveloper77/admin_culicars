                                ...
                                <div class="relative ">
                                    <div @click="isMenuOpen = !isMenuOpen" >
                                        <div v-if="placeholder" @click="clearSelectedValue"
                                            class="flex py-4 px-2 pl-4 hover:bg-fePrimary-50 dark:hover:bg-fePrimary-900 cursor-pointer items-center text-feSecondary-800 dark:text-feSecondary-300">
                                            {{ placeholder }}
                                        </div>
                                        <slot name="list"  />
                                    </div>
