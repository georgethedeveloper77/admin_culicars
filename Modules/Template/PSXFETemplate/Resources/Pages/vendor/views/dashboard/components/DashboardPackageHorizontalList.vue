...
<template>
    <div class="mx-auto mt-5 mb-10 xl:w-feLarge lg:w-large md:w-full md:px-6 lg:px-0 bg-feSecondary-800" v-if="packageStore.hasData()">
            <div class="flex flex-col justify-between gap-8 px-4 py-6 sm:flex-row sm:gap-5 sm:p-10">
        ...
        <div class="w-full sm:max-w-sm md:max-w-md lg:max-w-xl xl:max-w-3xl">
            ...
            <splide :options="options" :has-track="false">
                ...
                <div :class="'splide__arrows splide__arrows--' + languageStore.getLanguageDir()">
                    <button
                        class="p-2 border rounded shadow-sm bg-feSecondary-800 border-feSecondary-500 w-9 h-9 arrow splide__arrow--prev"
                    ...
                    <button
                        class="p-2 border rounded shadow-sm bg-feSecondary-800 border-feSecondary-500 w-9 h-9 arrow splide__arrow--next"
    ...
    setup(props) {
        ...
        async function buyAdClick() {
            ...
            if (loginUserId != '' && loginUserId != PsConst.NO_LOGIN_USER) {
                ...
                await PsUtils.waitingComponent(limit_item_modal, showLimitModel, 20);
        ...
        onMounted(() => {
            ...
            // packageStore.packageListWithPurchasedCountProps(props.getAllPackageHorizontalList);
        });
