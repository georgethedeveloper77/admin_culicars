<template>
    <div v-if="vendorSearchStore.vendorSearchList?.data?.length != 0 && vendorSearchStore.vendorSearchList?.data?.length != null" class="xl:w-feLarge lg:w-large md:w-full px-4 md:px-6 lg:px-0 mx-auto">
    ...
    export default defineComponent({
        ...
        setup(props) {
            ...
            onMounted(() => {
                ...
                // vendorSearchStore.getVendorSearchListProps(props.getAllVendorList);
            });
