                ...
                <div class="flex flex-col justify-items-center">
                    <div class="lg:my-12 mt-7 mb-12">
                        <div class="text-center sm:mb-10 mb-6 grid justify-items-center">
                            ...
                            <p class="text-sm font-medium text-feSecondary-500 dark:text-feSecondary-400">{{ blogStore.blog?.data?.addedUserName }} <span class="mx-6">|</span>
                        ...
                        <div class=" w-auto cursor-pointer grid justify-items-center">
                            ...
                            >
                            <div class="lg:mt-8 mt-6 w-full">
                                <p v-if="blogStore.blog.data != null">
                                    <span class="ck-content font-normal font-18 text-lg text-feSecondary-600 dark:text-feSecondary-200" v-html="blogStore.blog.data.description"> </span>
                                </p>
                            </div>
                        </div>
                    </div>
