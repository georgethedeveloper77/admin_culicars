<template>
    <div class="mt-6" v-if="!productStore.isUserItem(loginUserId)">
        <div v-if="selectedChatType != PsConst.NO_CHAT">
            <ps-route-link class="flex flex-grow" :to="{
                ...
                <ps-button class="flex items-center justify-center w-full" padding="px-4 py-1.5">
        ...
        <!-- WhatApp Button-->
        <ps-button v-if="whatsAppNo != ''" @click="toWhatsApp()" class="flex items-center justify-center w-full mt-4" colors="bg-green-900 text-feAchromatic-50" padding="px-4 py-1.5">
    ...
    <div class="mt-6" v-else>
        <div
            class="flex flex-col px-2 py-4 rounded-lg lg:p-4 bg-feSecondary-50 dark:bg-feSecondary-800">
        ...
        <div class="flex w-full gap-6 mt-7">
