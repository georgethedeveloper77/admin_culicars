                ...
                <div class=" w-full">
                        ...
                        <div class="w-full" v-if="appInfoStore?.appInfo?.data?.mobileSetting.is_show_subcategory == '1'">
                            <div class="  mb-4"
                                ...
                                <ps-dropdown align="left" class='lg:mt-2 mt-1  w-full'
                                    ...
                                    :placeholder="$t(coreField.placeholder)" @clear="paramHolder1.subCatName=''">
                                    <template #select>
                    ...
                    <div v-for="customFieldHeader in customFieldStore.customField.data?.customList.filter((customizeHeader)=>customizeHeader.coreKeysId != itemQuantityCoreKeysId)"
                        ...
                        <div class=" mb-4"
                            ...
                            <ps-dropdown align="left" class='lg:mt-2 mt-1  w-full'
                                :placeholder="$t(customFieldHeader.placeholder)" @clear="form.product_relation[customFieldHeader.coreKeysId]=''"
                    ...
                    <div class="flex flex-col sm:flex-row   mb-4">
                        ...
                        <div class=" mb-4  w-full me-6 sm:me-2 mb-4 sm:mb-0"
                            ...
                            :placeholder="$t(coreField.placeholder)" @clear="locationFilterClicked(emptyLocationCity)"
                        ...
                        <div class=" mb-4  w-full " v-if="appInfoStore.appInfo.data?.psAppSetting?.isSubLocation == '1'">
                            <div v-for="(coreField, index) in customFieldStore.customField.data?.coreList.filter((coreField) => coreField.fieldName === 'location_township_id' && coreField.isVisible === '1')"
                                ...
                                <ps-dropdown align="left" class='lg:mt-2 mt-1  w-full'
                                    :placeholder="$t(coreField.placeholder)" @clear="locationTownshipFilterClicked(emptyLocationTownship)"
...
export default {
    ...
    setup(props) {
        ...
        function locationFilterClicked(value) {
            ...
            emptyLocationTownship.lat = value.lat.toString();
            emptyLocationTownship.lng = value.lng.toString();
        ...
        async function submitClicked() {
            ...
            customFieldStore.customField.data?.customList.forEach((customField) => {
                ...
                if(customField.coreKeysId == itemQuantityCoreKeysId){
                    ...
                    if(isVendorSelected.value && (form.product_relation[itemQuantityCoreKeysId] == 0 || form.product_relation[itemQuantityCoreKeysId] < 0 || !form.product_relation[itemQuantityCoreKeysId])){
                    ...
                    if (isVendorSelected.value) {
                        ...
                        if (isZeroOrNegative && isNotNullOrUndefined) {
                            product_relation_errors.value[itemQuantityCoreKeysId] = `${customField.name} field must be greater than zero.`;
                            errorStatus = false;
                        }
                    }
                }
