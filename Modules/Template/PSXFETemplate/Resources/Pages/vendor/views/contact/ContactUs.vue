<template>
    ...
    <ps-content-container>
        <template #content>
            <div class="bg-feAchromatic-50 dark:bg-feAchromatic-900 rounded-lg w-auto sm:w-[700px]  sm:mt-32 lg:mt-36 mt-28 mb-16 mx-auto py-4 flex flex-col sm:flex-row ">
                ...
                <div class="w-full flex flex-col justify-center">
                    <div class="flex flex-row justify-center items-center">
                        <ps-label-header-6 class="font-semibold mt-4 sm:mt-0">{{$t("contact_us__get_in_touch_with_us")}}</ps-label-header-6>
                    ...
                    <div class="sm:ml-8 mr-8 sm:mr-20">
                    ...
                    <div class="flex flex-col items-center w-full sm:px-8 mb-4">
