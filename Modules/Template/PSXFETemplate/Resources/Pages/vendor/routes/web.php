...
use Modules\Template\PSXFETemplate\Http\Controllers\CategoryController;
...
Route::prefix('')->controller(MPCTemplate1Controller::class)->group(function (){
    ...
    Route::prefix('')->controller(FeDashboardController::class)->group(function (){
        Route::get('/', 'feDashboard')->name('dashboard');
    });
});
...
Route::middleware(["isFeSettingEnable"])->prefix('')->controller(MPCTemplate1Controller::class)->group(function (){
    ...
    Route::prefix('')->controller(BlogController::class)->group(function (){
        Route::get('/blog', 'list')->name('fe_blog');
        Route::get('/blog-detail', 'detail')->name('fe_blog_detail');
    });

    Route::prefix('')->controller(CategoryController::class)->group(function (){
        Route::get('/category', 'list')->name('fe_category.index');
    });
